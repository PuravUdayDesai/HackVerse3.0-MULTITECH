...
@CrossOrigin(origins = "*")
/*
 * Composter is the person who produces fertilizer outof biowaste
 */
public class CompostController {
	...
	public ResponseEntity<Void> addCompost(@Valid @RequestBody CompostModelInsert cmi) throws MessagingException {
	...
	/*
	 * This method is used to display filtered suppliers by state
	 */
	...
	/*
	 * This method is used to display filtered suppliers by city
	 */
