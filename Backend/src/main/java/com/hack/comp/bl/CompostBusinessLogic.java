...
public class CompostBusinessLogic
{
	...
	private static final String EXTERNAL_FILE_PATH = "/home/purav/Desktop/";
	...
	//Add Composter
	public ResponseEntity<Void> addCompost(CompostModelInsert cmi) throws MessagingException
	{
	 ...
	 public ResponseEntity<Double> subCompostProduct(ComposterDailyModelCompost data, Long init_id,Long farmerId,Date searchDate)
	 {
		...
		data = refreshCompostSubProduct( data, init_id );
