...
public class FarmerPurchaseHistoryModel {
	...
	public FarmerPurchaseHistoryModel()
	{
		
	}

	public FarmerPurchaseHistoryModel(@NotNull(message = "SupplierId cannot be NULL") Long incrementId,
